...
- [X] **13 сентября** — Корректировка проектов в репозитории / Рефакторинг.
- [X] **15 сентября** — TypeScript: Новая тема.
- [X] **17 сентября** — Frontend Профессия: Закрепление на практике.
- [X] **19 September** — TypeScript: Разбор сложных кейсов.
- [X] **21 сентября** — Создание мини-компонента с использованием TS.
- [X] **23 сентября** — TypeScript: Подготовка к финалу.
- [X] **25 сентября** — Frontend Профессия: Большой шаг вперед.
...
[Написать мне на почту](mailto:altynhalima25@mail.ru)
